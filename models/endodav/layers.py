...
def mark_only_part_as_trainable(model: nn.Module, bias: str = 'none', warm_up: bool = True, is_trainable: bool = True, train_output_conv: bool = False) -> None:
