...
class Project3D(nn.Module):
    ...
    def forward(self, points, K, T):
        ...
        return pix_coords, cam_points[:, 2:3, :] # [B, H, W, 2], [B, 1, H*W]
...
class SpatialTransformer(nn.Module):
    ...
    def forward(self, src, flow, padding='border'):
        """
        ...
        return F.grid_sample(src, new_locs, mode=self.mode, padding_mode=padding, align_corners=True)
